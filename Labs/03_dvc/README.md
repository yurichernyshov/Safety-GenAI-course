...
- Опишите, как интегрировать проверку dvc status в CI/CD пайплайн (например, GitHub Actions), чтобы сборка останавливалась при изменении данных без согласования.
